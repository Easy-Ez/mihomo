...
func (p ControlPacket) Encode(wrapper ControlWrapper, packetID uint32, unixTime uint32) ([]byte, error) {
...
func DecodeControlPacket(wrapper ControlWrapper, packet []byte) (*ControlPacket, uint32, uint32, error) {
	if wrapper == nil {
